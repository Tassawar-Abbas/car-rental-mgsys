...
export const Banner = ({ img, title, text, backgroundColor = '#f5f5f5' }) => {
  return (
    <div>
      <div className="h-[30vh] lg:h-[70vh] bg-no-repeat bg-center relative flex justify-center items-center"
        ...
        <div className='w-full lg:w-[70%] text-white'>
          ...
          <h2 className='text-lg md:text-4xl leading-6 md:leading-[55px] text-black'>
            {text}
          </h2>
        </div>
      </div>
